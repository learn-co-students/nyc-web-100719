...
* BONUS: allow users to hide hogs (not delete them, just hide them from view!)    ====> dirty pen!! Click from regular pen to move to dirty pen and click 'clean' button to move the pig back up 
