...
function getCandies() {
    fetch("http://localhost:4000/candies")
        ...
        .then(function (candiesArray) { /*take that array of candies and create new li's with each candy */
            console.log("in then")
            candiesArray.forEach(addCandy)
...
function persistCandy(candy) {
    ...
    // .then(function(resp){return resp.json()})
    // .then(function(candy){ addCandy(candy)})
}
